...
- [`docs/study/README.md`](docs/study/README.md) — curso guiado por módulo (data engineer → RAG)
...
└── docs/                          # Documentación (español; términos técnicos en inglés)
    ├── STUDY_PLAN.md              # Puntero al curso guiado
    ├── study/                     # Un archivo por módulo + índice
...
AI**, el curso está **separado por módulo** y pensado para que el agente
te guíe (explicación → código → parada → laboratorio):
[`docs/study/README.md`](docs/study/README.md). Empezá por el
[módulo 0](docs/study/m00-por-que-rag.md).
