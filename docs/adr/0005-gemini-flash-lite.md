...
3. **Multilingüe nativo**: la documentación es bilingüe (español + inglés). Gemini maneja el cambio de idioma con fluidez.
...
- **Negativas**: vendor lock-in parcial (solo API). Depende de la disponibilidad de Google AI Studio.
